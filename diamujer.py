...
<body>
    ...
    <h3>🌹Le deseo lo mejor en su día, sublime y valiosa mujer. MI querida y estimada brigadier Camila. Quiero deserarle un excelente dia lleno de bendiciones.🌹</h3>
    ...
    <div id="M" class="letter-content">
        <h2>🌹Carta con M🌹</h2>
         <h3>Maravillosa, una mujer con sus cualidades llena de amabilidad , valore y entrega por los demas es digno de admiracion por que usted es alguien que no tiene comparación, y como profesional se que va a ayudar a muchos y ser una mujer que deje huella en la psicologia del Ecuador y por que no del mundo, siempre la voy a querer, apoyar y admirar</h3>
    ...
    <div id="U" class="letter-content">
        <h2>🌹Carta con U🌹</h2>
         <h3>Unica, sabe que la hace tan especial? el hecho de poder dejar huella y legado en las personas que la conocemos es algo muy bonito su forma de ser alegre y carismatica es muy bonito su sonrisa que ilumina y belleza con inteligencia son una mezcla inigualable en el mundo.</h3>
    ...
    <div id="J" class="letter-content">
        <h2>🌹Carta con J🌹</h2>
         <h3>Joya y joven, tanto en espiritu, cuerpo y alma. Se que no seremos jovenes para siempre pero usted sigue igual de hermosa que cuando estudiaba en el colegio. Su gran corazón lleno de cariño y pasión por sus metas es muy valioso, es muy bonito ver como usted es multi tareas y siempre esta pendiente de los demas sin dejar sus metas a un lado. A su vez es una joya por lo valiosa que es usted y enserio me siento feliz de que este en mi vida</h3>
    ...
    <div id="E" class="letter-content">
        <h2>🌹Carta con E🌹</h2>
         <h3>Especial, siento que usted deja un legado lleno de enseñanzas en cualquier lugar que esta, y con su alegria ilumina la vida de todos, incluso me atrevo a decir que su sonrisa y su mirada iluminan toda su universidad, es mas todo el valle. Nunca se olvide que siempre la voy a apoyar incondicionalmente.</h3>
    ...
    <div id="R" class="letter-content">
        <h2>🌹Carta con R🌹</h2>
         <h3>Radiante, su belleza es incomparable y unica, nunca habra una mujer tan hermosa como usted en el mundo, por que usted es hermosa tanto por dentro como por fuera y esa combinación hoy en dia es algo que ya no hay, usted vale demasiado y es una gran mujer. Que tenga un excelente dia lleno de bendiciones.</h3>
    ...
    <div id="❤" class="letter-content">
        ...
        <div style="display: flex; justify-content: center; align-items: center;">
            ...
            <div style="margin: 20px;">
                ...
                <p>🌹C - Carismática y brillante🌹</p>
                <p>🌹A - Alegre y radiante🌹</p>
                <p>🌹M - Magnífica en su esencia🌹</p>
                <p>🌹I - Inspiradora cada día🌹</p>
                <p>🌹L - Llena de amor🌹</p>
                <p>🌹A - Admirable en su vida🌹</p>
            </div>
        </div>
